      ...
      >
        ...
        >
          <div>
            ...
            <p style={{ margintop: 10, fontSize: 15, color: "#ccc" }}>
              2nd Year B.Tech — Computer Science | Indian Institute of Information Technology, Sri City
            </p>
            <p style={{ margin: "4px 0", fontSize: 14, color: "#aaa" }}>
              📍 Sabla, Dungarpur, Rajasthan
            </p>
            <p style={{ margin: "4px 0", fontSize: 14, color: "#aaa" }}>
              ✉️ rajatjain3366@gmail.com | 📞 +91 7297925755
            </p>
          </div>
          ...
          >
            ...
            <p style={{ marginTop: 6, color: "#ccc" }}>
              2nd-year B.Tech CSE student experienced in ML, DL, and Full Stack Development.
        ...
        >
          ...
          <ul style={{ listStyle: "none", padding: 0, margin: 0, lineHeight: 1.8 }}>
            <li>
              <strong>B.Tech in Computer Science</strong> — Indian Institute of Information Technology, Sri City
              , 2024–2028 <br />
              <span style={{ color: "#aaa" }}>GPA: 8.15</span>
            </li>
        ...
        >
          {[
            { name: "🏆 LeetCode", link: "https://leetcode.com/RajatJain3366/" },
            { name: "💻 GitHub", link: "https://github.com/rajatjain3366" },
            { name: "💼 LinkedIn", link: "https://www.linkedin.com/in/rajatjain3366/" },
          ].map((site) => (
            <motion.a
              key={site.name}
              href={site.link}
